// MS-IME 準拠 ローマ字かな対応マップ
    ...
    export const romajiMap = {
        ...
        "イェ":["ye"],
        "ウァ":["wha"], "ウィ":["wi", "whi"], "ウェ":["we", "whe"], "ウォ":["who"],

        // カ行
        "カ":["ka", "ca"], "キ":["ki"], "ク":["ku", "cu", "qu"], "ケ":["ke"], "コ":["ko", "co"],
        "ヵ":["lka", "xka"], "ヶ":["lke", "xke"],
        "キャ":["kya"], "キィ":["kyi"], "キュ":["kyu"], "キェ":["kye"], "キョ":["kyo"],
        "クァ":["kwa", "qa", "qwa"], "クィ":["qwi","qi", "qyi"], "クゥ":["qwu"], "クェ":["qwe","qe", "qye"], "クォ":["qo", "qwo"],
        ...
        "ファ":["fa", "fwa"],"フィ":["fi", "fwi", "fyi"],"フゥ":["fwu"],"フェ":["fe", "fwe", "fye"],"フォ":["fo", "fwo"],
        ...
        // ヴ行
        "ヴァ":["va"], "ヴィ":["vi","vyi"], "ヴ":["vu"], "ヴェ":["ve","vye"], "ヴォ":["vo"],
